...
//  Fructus
//
//  Created by Serhan Khan on 21.02.23.
//
                ...
                VStack(spacing: 20) {
                    ...
                    GroupBox(
                        label: SettingsLabelView(labelText: "Application", labelImage: "apps.iphone")) {
                            SettingsRowView(name: "Developer", content: "Serhan / Khan")
                            
                            SettingsRowView(name: "Designer", content: "Narem Ozyoukselen")
                            
                            SettingsRowView(name: "Compatibility", content: "iOS 14")
                            
                            SettingsRowView(name: "Website", linkLabel: "SwiftUI Masterclass", linkDestination: "swiftuimasterclass.com")
                            
                            SettingsRowView(name: "Twitter", linkLabel: "@RobertPetra", linkDestination: "twitter.com/robertpetras")
